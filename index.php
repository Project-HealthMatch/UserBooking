...
function build_calendar($month,$year){
    $mysqli= new mysqli('localhost','root','root','appointment');
	        	...
	        	<form action="process.php" method="post">
		            <div class="form-group">
		                <div class='input-group date datetext' id='datepicker'>
		                    <input type='text' style="color:black;" name='date'class="form-control" required/>
...
<div style="text-align: center;" class="timezonetext">
<select name="timezoneid" required>
...
<div>
  ...
  <div class="grid">
   ...
   <div class="time" >
      ...
      <td>00:00-01:00</td>
      <th><input type="radio" name="slot" value="00:00-01:00"></th>
</div>


<div class="time">
      <td>01:00-02:00</td>
      <th><input type="radio"  name="slot" value="01:00-02:00"></th>
  </div>



 <div class="time"><td>02:00-03:00</td>
    <th><input type="radio"  name="slot" value="02:00-03:00"></th>

</div>

<div class="time">	  <td>03:00-04:00</td>
      <th><input type="radio"  name="slot" value="03:00-04:00"></th>
  </div>

  <div class="time">
      <td>04:00-05:00</td>
      <th><input type="radio" name="slot" value="04:00-05:00"></th>
  </div>

     <div class="time"> <td>05:00-06:00</td>
      <th><input type="radio"  name="slot" value="05:00-06:00"></th>
</div>


<div class="time"><td>06:00-07:00</td>
      <th><input type="radio"  name="slot" value="06:00-07:00"></th>
  </div>

  <div class="time">
      <td>07:00-08:00</td>
      <th><input type="radio" name="slot" value="07:00-08:00"></th>
  </div>
  ...
  <div class="time">
    ...
    <th><input type="radio"  name="slot" value="08:00-09:00"></th>
     </div>


     <div class="time">
	  <td>09:00-10:00</td>
      <th><input type="radio" name="slot" value="09:00-10:00"></th>
  </div>

  <div class="time">
      <td>10:00-11:00</td>
      <th><input type="radio"  name="slot" value="10:00-11:00"></th>
  </div>

  <div class="time">

      <td>11:00-12:00</td>
      <th><input type="radio" name="slot" value="11:00-12:00"></th>
 </div>

 <div class="time">
      <td>12:00-13:00</td>
      <th><input type="radio"  name="slot" value="12:00-13:00"></th>
  </div>

  <div class="time">
      <td>13:00-14:00</td>
      <th><input type="radio" name="slot" value="13:00-14:00"></th>
  </div>

  <div class="time">

      <td>14:00-15:00</td>
    <th><input type="radio" name="slot" value="14:00-15:00"></th>
    </div>

    <div class="time">
	  <td>15:00-16:00</td>
      <th><input type="radio" name="slot" value="15:00-16:00"></th>
  </div>

  <div class="time">
      <td>16:00-17:00</td>
      <th><input type="radio"  name="slot" value="16:00-17:00"></th>
  </div>


  <div class="time" >
      <td>17:00-18:00</td>
      <th><input type="radio" name="slot" value="17:00-18:00"></th>
 </div>


 <div class="time">
	  <td>18:00-19:00</td>
    <th><input type="radio"  name="slot" value="18:00-19:00"></th>
    ...
    <div class="time">
      ...
      <td>19:00-20:00</td>
      <th><input type="radio"  name="slot" value="19:00-20:00"></th>
  </div>


  <div class="time">
      <td>20:00-21:00</td>
      <th><input type="radio" name="slot" value="20:00-21:00"></th>
    </div>

    <div class="time">

      <td>21:00-22:00</td>
    <th><input type="radio" name="slot" value="21:00-22:00"></th>
    </div>

    <div class="time">
	  <td>22:00-23:00</td>
      <th><input type="radio" name="slot" value="22:00-23:00"></th>
  </div>

  <div class="time">
      <td>23:00-00:00</td>
      <th><input type="radio"  name="slot" value="23:00-00:00"></th>
      </div>
